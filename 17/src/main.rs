...
fn main() {
    ...
    let mut f = File::create("claymap.txt").unwrap();
                ...
                if found_y_collision {
                    ...
                    'scale_walls: loop {
                        ...
                        loop {
                            ...
                            // also checks if tile is not water
    ...
    println!("{}", watered_area.len());
    // for y in 0..20 {
    //     for x in 490..510 {
    //         if watered_area.contains(&(x, y)) {
    //             print!("~");
    //         } else {
    //             print!(".")
    //         }
